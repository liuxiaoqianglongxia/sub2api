export default {
  ...
  imageGeneration: {
    title: 'GPT Images',
    description: 'Choose an available key and submit a prompt',
    apiKey: 'API Key',
    selectKey: 'Select API key',
    model: 'Model',
    prompt: 'Prompt',
    promptPlaceholder: 'Describe the subject, style, composition, and details',
    size: 'Size',
    quality: 'Quality',
    count: 'Images',
    auto: 'Auto',
    ...
    noImageKeys: 'No active key has image generation enabled',
    noSelectedKey: 'Select an API key for image generation',
    promptRequired: 'Enter a prompt',
    generate: 'Generate',
    generating: 'Generating...',
    empty: 'Generated images will appear here',
    resultAlt: 'Generated image',
    emptyResponse: 'No image was returned',
